...
#define TSK_ACTIVE_MM 1216 /* offsetof(struct task_struct, active_mm) */
#define TSK_CPU 72 /* offsetof(struct task_struct, cpu) */
...
#define TSK_TI_PREEMPT_LAZY 8 /* offsetof(struct task_struct, thread_info.preempt_lazy_count) */
#define TSK_STACK 32 /* offsetof(struct task_struct, stack) */
#define TSK_STACK_CANARY 1400 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 6848 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 7920 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 7816 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 7896 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 7912 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define MM_CONTEXT_ID 800 /* offsetof(struct mm_struct, context.id.counter) */
...
#define TRAMP_VALIAS -8627703808 /* TRAMP_VALIAS */
